              ...
              <div className="col-span-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-sm text-blue-700 mb-4">
                    Enter a job URL from any supported job board below (LinkedIn, Handshake, Indeed, Built In NYC, The Muse, Untapped, WayUp, RippleMatch, or Simplify), and we'll automatically populate the job details for
                  </p>
