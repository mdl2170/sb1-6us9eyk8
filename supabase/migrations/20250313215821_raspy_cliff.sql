/*
  # Fix attention level history function type mismatch
  
  1. Changes
    - Fix type mismatch between timestamp and date
    - Cast timestamp to date in the function
...
-- Create new version of the function with proper date handling
...
BEGIN
  ...
  WITH RECURSIVE months AS (
    -- Generate series of months, explicitly cast to date
