/*
  # Recreate attention level history function
  
  1. Changes
    - Drop existing function
    - Create new function that calculates attention level distribution
    - Add proper security and performance optimizations
...
-- Create new function with updated attention levels
...
BEGIN
  ...
  student_reviews AS (
    -- Get all students assigned to the coach
    SELECT 
      s.id as student_id,
      m.month_start,
      COALESCE(
