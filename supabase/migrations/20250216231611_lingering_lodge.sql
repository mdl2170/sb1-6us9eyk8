...
-- Update the fetchStudentPerformance function to use direct table access
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'student', jsonb_build_object(
      ...
      'status', s.status,
      'attention_level', COALESCE(pr.attention_level, 'level_4'),
      'performance_rating', COALESCE(pr.performance_rating, 'medium'),
